...
string Calculator::decimal_to_binary(float arg_input){
    string result;
...
float binary_to_decimal_float(string str){
    ...
    return s_datablock.f_value;
}


string Calculator::binary_to_decimal(string str){
...
string Calculator::addition_algorithm(string bin_A, string bin_B, bool debug_mode){
...
string Calculator::product_algorithm(string bin_A, string bin_B, bool debug_mode) {
...
int main() {
    ...
    cout << " 2: " << decimal_to_binary(2)<< endl;;
     cout << product_algorithm(decimal_to_binary(5), decimal_to_binary(2), true) << endl;
